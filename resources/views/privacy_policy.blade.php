    ...
    <section id="about">
        <div class="container px-4">
            <div class="row gx-4 justify-content-center">
                <div class="col-lg-8">
                    <h1>Privacy Policy for Smart Tourism Pemalang</h1>

                    <p>At Smart Tourism Pemalang, accessible from https://smarttourismpemalang.codes/, one of our main
                        priorities is the privacy of our visitors. This Privacy Policy document contains types of
                        information that is collected and recorded by Smart Tourism Pemalang and how we use it.</p>
                    ...
                    <p>Smart Tourism Pemalang follows a standard procedure of using log files. These files log visitors
                    ...
                    <p>Like any other website, Smart Tourism Pemalang uses 'cookies'. These cookies are used to store
                    ...
                    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of
                        Smart Tourism Pemalang.</p>

                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                        that are used in their respective advertisements and links that appear on Smart Tourism
                        Pemalang, which are sent directly to users' browser. They automatically receive your IP address
                    ...
                    <p>Note that Smart Tourism Pemalang has no access to or control over these cookies that are used by
                        third-party advertisers.</p>

                    <h2>Third Party Privacy Policies</h2>

                    <p>Smart Tourism Pemalang's Privacy Policy does not apply to other advertisers or websites. Thus, we
                    ...
                    <p>Smart Tourism Pemalang does not knowingly collect any Personal Identifiable Information from
                    ...
                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                        website with regards to the information that they shared and/or collect in Smart Tourism
                        Pemalang. This policy is not applicable to any information collected offline or via channels
