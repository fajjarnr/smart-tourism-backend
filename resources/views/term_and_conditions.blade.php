...
<body id="page-top">
    <!-- Navigation-->
    <nav class="navbar navbar-expand-lg navbar-dark bg-orange fixed-top" id="mainNav">
        <div class="container px-4">
            <a class="navbar-brand" href="#page-top">Smart Tourism Pemalang</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('privacy_policy') }}">Privacy Policy</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('term_and_conditions') }}">Term and
                            Condition</a></li>
                </ul>
            </div>
        </div>
    ...
    <!-- Header-->
    <header class="bg-primary bg-orange text-white">
        ...
        <div class="container px-4">
            <div class="row gx-4 justify-content-center">
                <div class="col-lg-8">
                    ...
                    <p>Welcome to Smart Tourism Pemalang!</p>

                    <p>These terms and conditions outline the rules and regulations for the use of Smart Tourism
                        Pemalang's Website, located at https://smarttourismpemalang.codes/.</p>

                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                        Smart Tourism Pemalang if you do not agree to take all of the terms and conditions stated on
                        this page.</p>
                    ...
                    <p>We employ the use of cookies. By accessing Smart Tourism Pemalang, you agreed to use cookies in
                        agreement with the Smart Tourism Pemalang's Privacy Policy.</p>
                    ...
                    <p>Unless otherwise stated, Smart Tourism Pemalang and/or its licensors own the intellectual
                        property rights for all material on Smart Tourism Pemalang. All intellectual property rights are
                        reserved. You may access this from Smart Tourism Pemalang for your own personal use subjected to
                        restrictions set in these terms and conditions.</p>

                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from Smart Tourism Pemalang</li>
                        <li>Sell, rent or sub-license material from Smart Tourism Pemalang</li>
                        <li>Reproduce, duplicate or copy material from Smart Tourism Pemalang</li>
                        <li>Redistribute content from Smart Tourism Pemalang</li>
                    </ul>

                    <p>This Agreement shall begin on the date hereof.</p>

                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                        information in certain areas of the website. Smart Tourism Pemalang does not filter, edit,
                        publish or review Comments prior to their presence on the website. Comments do not reflect the
                        views and opinions of Smart Tourism Pemalang,its agents and/or affiliates. Comments reflect the
                        views and opinions of the person who post their views and opinions. To the extent permitted by
                        applicable laws, Smart Tourism Pemalang shall not be liable for the Comments or for any
                    ...
                    <p>Smart Tourism Pemalang reserves the right to monitor all Comments and to remove any Comments
                    ...
                    <p>You hereby grant Smart Tourism Pemalang a non-exclusive license to use, reproduce, edit and
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                        ...
                        hyperlink compensates the absence of Smart Tourism Pemalang; and (d) the link is in the context
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                        our website, you must inform us by sending an e-mail to Smart Tourism Pemalang. Please include
                    ...
                    <p>No use of Smart Tourism Pemalang's logo or other artwork will be allowed for linking absent a
    ...
    <footer class="py-5 bg-dark">
        <div class="container px-4">
            <p class="m-0 text-center text-white">Copyright &copy; Smart Tourism Pemalang 2021</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
